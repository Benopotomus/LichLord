...
#define MICROSPLAT_SAMPLE_SPECULAR(u, cl, l) StochasticSampleSpecular(u, cl, l)
	...
	void DoBlight(Input i, inout MicroSplatLayer o, Config c, float camDist, float3 worldVertexNormal, float3 worldPos)
	{
      ...
      MicroSplatLayer Sample(Input i, half4 weights, inout Config config, float camDist, float3 worldNormalVertex, DecalOutput decalOutput)
      {
        ...
        #if _BLIGHT
            DoBlight(i, o, config, camDist, worldNormalVertex, i.worldPos);
        #endif
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_Base355011740"
   Fallback "Hidden/Terrain_Base355011740"
