...
{
    [CreateAssetMenu(fileName = "DestructiblePropDataDefinition", menuName = "LichLord/Props/DestructiblePropDataDefinition")]
    public class DestructiblePropDataDefinition : PropDataDefinition
    {
        [SerializeField]
