        ...
        public override void Spawned()
        {
            if (Runner.IsSharedModeMasterClient || Runner.GameMode == GameMode.Single)
            {
                ...
                for (int i = 0; i < _debugSpawnCount; i++)
                {
                    ...
                    SpawnNPC(randomPosition, Global.Tables.NonPlayerCharacterTable.TryGetDefinition(2), ETeamID.EnemiesTeamA);
                }
                ...
                for (int i = 0; i < _debugSpawnCount; i++)
                {
                    ...
                    SpawnNPC(randomPosition, Global.Tables.NonPlayerCharacterTable.TryGetDefinition(2), ETeamID.EnemiesTeamB);
                }
            }
        }
