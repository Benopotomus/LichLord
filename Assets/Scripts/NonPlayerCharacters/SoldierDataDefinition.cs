...
namespace LichLord.NonPlayerCharacters
{
    ...
    public class SoldierDataDefinition : NonPlayerCharacterDataDefinition
    {
        ...
        // Dialog NPC
        public int GetDialogIndex(ref FNonPlayerCharacterData npcData)
        {
