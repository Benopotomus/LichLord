...
{
    [System.Serializable]
    public class ImpactVisualLoader
    {
        ...
        public System.Action<ImpactVisualLoader> OnLoadComplete;

        public ImpactVisualLoader() { }
        public ImpactVisualLoader(Transform attachment, Quaternion rotation,
