...
{
   public class PipelineHDRP2022 : IPipelineAdapter
   {
      ...
      {
         StringBuilder template = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022.txt"));

         var passGBuffer = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassGBuffer.txt"));
         var passShadow = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassShadow.txt"));
         var passDepthOnly = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassDepthOnly.txt"));
         var passDepthForwardOnly = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassDepthForwardOnly.txt"));

         var passForward = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassForward.txt"));
         var passMeta = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassMeta.txt"));
         var passSceneSelect = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassSceneSelection.txt"));
         var vert = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_Vert.txt"));
         var hdrpShared = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_shared.txt"));
         var hdrpInclude = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_include.txt"));

         var passMotion = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassMotionVector.txt"));
         var passPicking = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassPicking.txt"));
         var passTransparentDepth = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassTransparentDepthPrepass.txt"));
         var passFullDebug = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassFullScreenDebug.txt"));
         var passForwardUnlit = new StringBuilder(util.LoadTemplate("BetterShaders_Template_HDRP2022_PassForwardUnlit.txt"));

        if (options.shaderType == Options.ShaderType.Decal)
        {
            template = new StringBuilder(util.LoadTemplate("BetterShaders_Template_Decal_HDRP2022.txt"));
            passForward = new StringBuilder(util.LoadTemplate("BetterShaders_Template_Decal_HDRP2022_Passes.txt"));
            passGBuffer.Clear();
            passMotion.Clear();
            passPicking.Clear();
