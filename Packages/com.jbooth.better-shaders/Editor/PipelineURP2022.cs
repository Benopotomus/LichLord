...
{
   public class PipelineURP2022 : IPipelineAdapter
   {
      ...
      {
         StringBuilder template = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022.txt"));

         var passforward = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassForward.txt"));
         var passShadow = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassShadow.txt"));
         var passMeta = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassMeta.txt"));
         var passDepthOnly = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassDepthOnly.txt"));
         var vert = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_Vert.txt"));
         var urpInclude = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_include.txt"));
         var passDepthNormals = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassDepthNormals.txt"));
         var passGBuffer = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2022_PassGBuffer.txt"));
