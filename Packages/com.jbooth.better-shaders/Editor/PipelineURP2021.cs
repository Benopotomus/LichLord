...
{
   public class PipelineURP2021 : IPipelineAdapter
   {
      ...
      {
         StringBuilder template = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021.txt"));

         var passforward = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassForward.txt"));
         var passShadow = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassShadow.txt"));
         var passMeta = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassMeta.txt"));
         var passDepthOnly = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassDepthOnly.txt"));
         var vert = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_Vert.txt"));
         var urpInclude = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_include.txt"));
         var passDepthNormals = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassDepthNormals.txt"));
         var passGBuffer = new StringBuilder(util.LoadTemplate("BetterShaders_Template_URP2021_PassGBuffer.txt"));
         ...
         {
            passforward = new StringBuilder(util.LoadTemplate("BetterShaders_Template_Decal_URP2021_Passes.txt"));
            template = new StringBuilder(util.LoadTemplate("BetterShaders_Template_Decal_URP2021.txt"));
            passGBuffer.Clear();
